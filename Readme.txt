...
Got the downloads working and the CSS file connected to the index file.
Changed the background gradient colors.
Changed the header colors and shadow colors.
Changed the paragraph colors.
Changed H3 colors.
Added underline and bold to h1.
Italicized H2.
Changed H1 font and font family.
Changed H3 and paragraph font and font family.
Added some extra breaks.
Centered H1 and H2.
Went back and fixed some colors.
